function chargement_biodivafreid_locations() {
	showConnexionStatus();
	...
	if (option == 1) {
		...
		DB.allDocs({  		
			...
			if (typeof(JSON.stringify(result)) != "undefined"){  
				...
				addValue('sess_check');	
				addValue('location_name');	
				addValue('country');	
				addValue('province');	
				addValue('locality');
				addValue('site_details');
				addValue('latitude');	
				addValue('lat_ns');	
				addValue('longitude');	
				addValue('long_ew');
				addValue('coord_source');	
				addValue('gps_projection');	
				addValue('gps_datum');
				addValue('coord_precision');
				addValue('altitude');	
				addValue('alt_source');	
				addValue('Mapgrid');	
				addValue('habitat_Type');
				addValue('rodent_proofing');	
				addValue('inside_cover');	
				addValue('outside_cover');	
				addValue('open_water');	
				addValue('recent_rodent_control');
				addValue('pictures');	
				addValue('habitat_remarks');
