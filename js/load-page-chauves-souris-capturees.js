function chargement_chauves_souris_capturees() {
	showConnexionStatus();
	...
	if (option == 1) {
		...
		DB.allDocs({  		
			...
			if (typeof(JSON.stringify(result)) != "undefined"){  
				...
				addValue('Dans',true);
				addValue('Dans_autre');
				addValue('Lieu_de_capture');
				addValue('Proximite_du_village_ville');
				addValue('Methode_de_capture');
				addValue('Espece_identifiee');
				addValue('Type_de_chauve_souris');
				...
				addValue('Sexe_jeune');																	
				addValue('Poids_jeune');
				addValue('N_ident_jeune');
				addValue('Remarques');
				addValue('Mesureur');
				addValue('Poids_g');
				...
				var Element = document.getElementById('Mort_due_a_la_capture_manip_euthanasie'); 
				if (result.rows[0].doc.Mort_due_a_la_capture_manip_euthanasie === true) {
					Element.checked = true;
				} else {
					Element.checked = false;
				}
				
				addValue('Si_relachee_marquage');
				addValue('Si_marquee_numero');
				addValue('Sang_papier_buvard');
				addValue('Ecouv_gorge_RNAl');
				addValue('Wing_punch_ethanol');
				addValue('Feces_RNAl');
				addValue('Urine_RNAl');
				addValue('Feces_et_urine_RNAl');
